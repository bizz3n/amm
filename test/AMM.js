...
describe('AMM', () => {
  ...
  beforeEach(async () => {
    ...
    // Send token to liquidity provider
  ...
  describe('Deployment', () => {
    ...
    it('facilitates swaps', async () => {
      ...
      // Depoloyer should still have 100 shares
      ...
      // Check inverstor1 balance before swap
      ...
      ////////////////////////////////////////////
      // Investor 1 swaps Large Amou t
      //


      // check investor balance beforew swap
      balance = await token2.balanceOf(investor1.address)
      console.log(`Investor1 Token2 balance before swap: ${ethers.utils.formatEther(balance)}`)
      ...
      // Estimate amount of tokens invenstor2 will receive after swapping token2: includes slippage
      ...
      // Deploher should have 100 shares
