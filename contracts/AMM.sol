...
contract AMM {
	...
	function addLiquidity(uint256 _token1Amount, uint256 _token2Amount) external {
		...
		// If first time adding liquidity, makre share 100
		if (totalShares == 0) {
			share = 100 * PRECISION;
		} else {
	...
	// Determine how many token2 tokens must be depositited 
	...
	// Determine how many token1 tokens must be depositited 
	...
	returns(uint256 token2Amount)
	{
		...
		// 4. Tranfer token2 token from contract to user wallet
	...
	// Determin how many tokens will be withdrawn
